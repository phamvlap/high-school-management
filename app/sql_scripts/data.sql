...
call add_student(-1, 'Nguyễn Thị Lan', '2007-05-15', '123 ABC Street, XYZ City', '0123456789', 1, '2023-2024');
call add_student(-1, 'Trần Văn Đức', '2006-09-20', '456 XYZ Street, ABC City', '0987654321', 2, '2023-2024');
call add_student(-1, 'Phạm Thị Hương', '2008-12-10', '789 DEF Street, GHI City', '0369852147', 3, '2023-2024');
call add_student(-1, 'Lê Văn Hòa', '2007-03-25', '321 GHI Street, DEF City', '0542136987', 4, '2023-2024');
call add_student(-1, 'Hoàng Thị Mai', '2006-07-08', '654 JKL Street, MNO City', '0789654321', 5, '2023-2024');
call add_student(-1, 'Mai Văn Tú', '2008-10-30', '987 MNO Street, JKL City', '0912345678', 6, '2023-2024');
call add_student(-1, 'Đặng Minh Hiếu', '2007-04-12', '147 PQR Street, STU City', '0654321897', 7, '2023-2024');
call add_student(-1, 'Vũ Thị Hương', '2006-06-18', '258 STU Street, PQR City', '0321654987', 8, '2023-2024');
call add_student(-1, 'Trương Văn Đức', '2008-11-05', '369 VWX Street, YZ City', '0965741238', 9, '2023-2024');
call add_student(-1, 'Lý Thanh Tùng', '2007-08-28', '741 YZ Street, VWX City', '0398574126', 10, '2023-2024');
call add_student(-1, 'Nguyễn Thị Lan', '2007-05-15', '123 ABC Street, XYZ City', '0123456789', 1, '2023-2024');
call add_student(-1, 'Trần Văn Đức', '2006-09-20', '456 XYZ Street, ABC City', '0987654321', 2, '2023-2024');
call add_student(-1, 'Phạm Thị Hương', '2008-12-10', '789 DEF Street, GHI City', '0369852147', 3, '2023-2024');
call add_student(-1, 'Lê Văn Hòa', '2007-03-25', '321 GHI Street, DEF City', '0542136987', 4, '2023-2024');
...
call add_student(-1, 'Trương Văn Đức', '2008-11-05', '369 VWX Street, YZ City', '0965741238', 9, '2023-2024');
call add_student(-1, 'Lý Thanh Tùng', '2007-08-28', '741 YZ Street, VWX City', '0398574126', 10, '2023-2024');
call add_student(-1, 'Nguyễn Thị Anh', '2007-09-15', '123 ABC Street, XYZ City', '0123456789', 1, '2023-2024');
call add_student(-1, 'Trần Văn An', '2006-08-20', '456 XYZ Street, ABC City', '0987654321', 2, '2023-2024');
call add_student(-1, 'Phạm Thị Bình', '2008-11-10', '789 DEF Street, GHI City', '0369852147', 3, '2023-2024');
call add_student(-1, 'Lê Văn Cường', '2007-02-25', '321 GHI Street, DEF City', '0542136987', 4, '2023-2024');
call add_student(-1, 'Hoàng Thị Dung', '2006-04-08', '654 JKL Street, MNO City', '0789654321', 5, '2023-2024');
call add_student(-1, 'Mai Thị Hạnh', '2008-07-30', '987 MNO Street, JKL City', '0912345678', 6, '2023-2024');
call add_student(-1, 'Đặng Văn Đông', '2007-10-12', '147 PQR Street, STU City', '0654321897', 7, '2023-2024');
call add_student(-1, 'Vũ Thị Linh', '2006-06-18', '258 STU Street, PQR City', '0321654987', 8, '2023-2024');
call add_student(-1, 'Trương Văn Tài', '2008-05-05', '369 VWX Street, YZ City', '0965741238', 9, '2023-2024');
call add_student(-1, 'Lý Thị Quỳnh', '2007-03-28', '741 YZ Street, VWX City', '0398574126', 10, '2023-2024');
call add_student(-1, 'Nguyễn Văn Dương', '2007-09-15', '123 ABC Street, XYZ City', '0123456789', 1, '2023-2024');
call add_student(-1, 'Trần Thị Hồng', '2006-08-20', '456 XYZ Street, ABC City', '0987654321', 2, '2023-2024');
call add_student(-1, 'Phạm Văn Nam', '2008-11-10', '789 DEF Street, GHI City', '0369852147', 3, '2023-2024');
call add_student(-1, 'Lê Thị Thảo', '2007-02-25', '321 GHI Street, DEF City', '0542136987', 4, '2023-2024');
call add_student(-1, 'Hoàng Văn Anh', '2006-04-08', '654 JKL Street, MNO City', '0789654321', 5, '2023-2024');
call add_student(-1, 'Mai Văn Hùng', '2008-07-30', '987 MNO Street, JKL City', '0912345678', 6, '2023-2024');
call add_student(-1, 'Đặng Thị Thu', '2007-10-12', '147 PQR Street, STU City', '0654321897', 7, '2023-2024');
call add_student(-1, 'Vũ Thị Huệ', '2006-06-18', '258 STU Street, PQR City', '0321654987', 8, '2023-2024');
call add_student(-1, 'Trương Văn Hòa', '2008-05-05', '369 VWX Street, YZ City', '0965741238', 9, '2023-2024');
call add_student(-1, 'Lý Thị Kim', '2007-03-28', '741 YZ Street, VWX City', '0398574126', 10, '2023-2024');
call add_student(-1, 'Nguyễn Thị Lan', '2007-09-15', '123 ABC Street, XYZ City', '0123456789', 1, '2023-2024');
call add_student(-1, 'Trần Văn An', '2006-08-20', '456 XYZ Street, ABC City', '0987654321', 2, '2023-2024');
call add_student(-1, 'Phạm Thị Bình', '2008-11-10', '789 DEF Street, GHI City', '0369852147', 3, '2023-2024');
call add_student(-1, 'Lê Văn Cường', '2007-02-25', '321 GHI Street, DEF City', '0542136987', 4, '2023-2024');
call add_student(-1, 'Hoàng Thị Dung', '2006-04-08', '654 JKL Street, MNO City', '0789654321', 5, '2023-2024');
...
call add_student(-1, 'Lý Thị Quỳnh', '2007-03-28', '741 YZ Street, VWX City', '0398574126', 10, '2023-2024');
call add_student(-1, 'Nguyễn Thị Lan', '2007-05-15', '123 ABC Street, XYZ City', '0123456789', 1, '2023-2024');
call add_student(-1, 'Trần Văn Anh', '2006-09-20', '456 XYZ Street, ABC City', '0987654321', 2, '2023-2024');
call add_student(-1, 'Phạm Thị Bảo', '2008-12-10', '789 DEF Street, GHI City', '0369852147', 3, '2023-2024');
call add_student(-1, 'Lê Văn Cường', '2007-03-25', '321 GHI Street, DEF City', '0542136987', 4, '2023-2024');
call add_student(-1, 'Hoàng Thị Dung', '2006-07-08', '654 JKL Street, MNO City', '0789654321', 5, '2023-2024');
call add_student(-1, 'Mai Thị Hạnh', '2008-10-30', '987 MNO Street, JKL City', '0912345678', 6, '2023-2024');
call add_student(-1, 'Đặng Minh Hiếu', '2007-04-12', '147 PQR Street, STU City', '0654321897', 7, '2023-2024');
call add_student(-1, 'Vũ Thị Lan', '2006-06-18', '258 STU Street, PQR City', '0321654987', 8, '2023-2024');
call add_student(-1, 'Trương Văn Tài', '2008-05-05', '369 VWX Street, YZ City', '0965741238', 9, '2023-2024');
call add_student(-1, 'Lý Thị Mai', '2007-08-28', '741 YZ Street, VWX City', '0398574126', 10, '2023-2024');
call add_student(-1, 'Nguyễn Thị Lan', '2007-05-15', '123 ABC Street, XYZ City', '0123456789', 1, '2023-2024');
call add_student(-1, 'Trần Văn Anh', '2006-09-20', '456 XYZ Street, ABC City', '0987654321', 2, '2023-2024');
call add_student(-1, 'Phạm Thị Bảo', '2008-12-10', '789 DEF Street, GHI City', '0369852147', 3, '2023-2024');
call add_student(-1, 'Lê Văn Cường', '2007-03-25', '321 GHI Street, DEF City', '0542136987', 4, '2023-2024');
...
CALL add_teaching(1, 1, '2023-2024');
CALL add_teaching(2, 2, '2023-2024');
CALL add_teaching(3, 3, '2023-2024');
CALL add_teaching(4, 4, '2023-2024');
CALL add_teaching(5, 5, '2023-2024');
CALL add_teaching(6, 6, '2023-2024');
CALL add_teaching(7, 7, '2023-2024');
CALL add_teaching(8, 8, '2023-2024');
CALL add_teaching(9, 9, '2023-2024');
CALL add_teaching(10, 10, '2023-2024');
CALL add_teaching(11, 11, '2023-2024');
CALL add_teaching(12, 12, '2023-2024');
CALL add_teaching(13, 13, '2023-2024');
CALL add_teaching(14, 14, '2023-2024');
CALL add_teaching(15, 15, '2023-2024');
CALL add_teaching(16, 16, '2023-2024');
CALL add_teaching(17, 17, '2023-2024');
CALL add_teaching(18, 18, '2023-2024');
CALL add_teaching(19, 19, '2023-2024');
CALL add_teaching(20, 20, '2023-2024');
CALL add_teaching(21, 21, '2023-2024');
CALL add_teaching(22, 22, '2023-2024');
CALL add_teaching(23, 23, '2023-2024');
CALL add_teaching(24, 24, '2023-2024');
CALL add_teaching(25, 25, '2023-2024');
CALL add_teaching(26, 26, '2023-2024');
CALL add_teaching(27, 27, '2023-2024');
CALL add_teaching(28, 28, '2023-2024');
CALL add_teaching(29, 29, '2023-2024');
CALL add_teaching(30, 30, '2023-2024');
